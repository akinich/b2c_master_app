...
from config.database import ActivityLogger, WooCommerceDB
...
def show_products_tab(username: str, is_admin: bool):
    ...
    if is_admin:
        ...
        column_config = {
            ...
            "regular_price": st.column_config.NumberColumn("Regular Price", format="Rs. %.2f"),
            "sale_price": st.column_config.NumberColumn("Sale Price", format="Rs. %.2f"),
        ...
        column_config = {
            ...
            "regular_price": st.column_config.NumberColumn("Regular Price", format="Rs. %.2f", disabled=True),
            "sale_price": st.column_config.NumberColumn("Sale Price", format="Rs. %.2f", disabled=True),
            "hsn": st.column_config.TextColumn("HSN", help="Numeric only"),
            "zoho_name": st.column_config.TextColumn("Zoho Name"),
